...
import 'package:casadealerapp/sum_todo.dart';
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Text('Street Wear',
                                        style: TextStyle(fontWeight: FontWeight.bold, fontSize: 2.3.h),
                                        ),
                                SizedBox(width: 5.w),
                                Text('₹125', style: TextStyle(color: Color(0xff5a5a9f)),
                                ),
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                Text('Color : Red   Size : M',
                                  style: TextStyle(color: Color(0xff5a5a9f)),
                                ),
